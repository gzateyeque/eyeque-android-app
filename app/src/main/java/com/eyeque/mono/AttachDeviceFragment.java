 ...
 */
public class AttachDeviceFragment extends Fragment {
    ...
    public static AttachDeviceFragment newInstance(String param1, String param2) {
        AttachDeviceFragment fragment = new AttachDeviceFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int color;
        View rootView = inflater.inflate(R.layout.fragment_attach_device, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onAttachDeviceFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            throw new RuntimeException(context.toString()
                    + " must implement OnAttachDeviceFragmentInteractionListener");
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onAttachDeviceFragmentInteraction(Uri uri);
    }
}
